    ...
    context "on #{os}" do
      ...
      context 'user1' do
        ...
        context 'home path is set' do
          ...
          it {
            is_expected.to contain_file('/srv/user1').with(
              ensure: 'directory',
              owner: 'user1',
              group: 'user1',
            )
        ...
        context 'with bash files content' do
          ...
          it {
            is_expected.to contain_file('/home/user1/.bash_profile').with(
              ensure: 'present',
              owner: 'user1',
              mode: '0644',
            )
        ...
        context 'with bash files source' do
          ...
          it { is_expected.to contain_file('/home/user1/.bashrc').with_ensure('present') }
          it { is_expected.to contain_file('/home/user1/.bash_profile').with_ensure('present') }
        end
        ...
        context 'with bashrc source and content' do
          ...
          it do
            expect { is_expected.to compile }.to \
              raise_error(%r{\*\*\*use bashrc_source or bashrc_content parameter\*\*\*})
          end
        end
        ...
        context 'with bash_profile source and content' do
          ...
          it do
            expect { is_expected.to compile }.to \
              raise_error(%r{\*\*\*use bash_profile_source or bash_profile_content parameter\*\*\*})
          end
        end
      end
    end
